    ...
    public function store(Request $request)
    {
        ...
        if ($existingAsset) {
            return redirect()->route('assets.show', $existingAsset)
                             ->with('warning', '⚠️ This file already exists in the system.');
        }
        ...
        if (!empty($similarAssets)) {
            ...
            return redirect()->route('assets.show', $asset)
                             ->with('warning', "Asset uploaded. ⚠️ Similar assets detected: #{$similarIds}");
        }

        return redirect()->route('assets.show', $asset)
                         ->with('success', 'Asset uploaded and metadata generated by AI.');
    }
